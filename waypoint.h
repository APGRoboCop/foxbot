...
enum {
   S_FL_POINT1 = 1 << 0, /* point1 */
   S_FL_POINT2 = 1 << 1, /* point2 */
   S_FL_POINT3 = 1 << 2, /* point3 */
   S_FL_POINT4 = 1 << 3, /* point4 */
   S_FL_POINT5 = 1 << 4, /* point5 */
   S_FL_POINT6 = 1 << 5, /* point6 */
   S_FL_POINT7 = 1 << 6, /* point7 */
   S_FL_POINT8 = 1 << 7  /* point8 */
};
