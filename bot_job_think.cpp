...
const jobList_struct jl[JOB_TYPE_TOTAL] = {
	...
	{ 470, "JOB_BUFF_ALLY" }, { 600, "JOB_ESCORT_ALLY" },
	{ 460, "JOB_CALL_MEDIC" }, // this should be a higher priority than JOB_GET_HEALTH
	{ 450, "JOB_GET_HEALTH" }, { 440, "JOB_GET_ARMOR" }, { 660, "JOB_GET_AMMO" }, { 610, "JOB_DISGUISE" },
	...
	{ 390, "JOB_DETPACK_WAYPOINT" }, { 490, "JOB_PIPETRAP" }, { 590, "JOB_INVESTIGATE_AREA" },
