...
jobList_struct jl[JOB_TYPE_TOTAL] = {   //Only handles 32 not 45? [APG]RoboCop[CL]
    ...
    { 540, "JOB_REPORT" }, { 480, "JOB_PICKUP_ITEM" }, { 530, "JOB_PICKUP_FLAG" },
    { 800, "JOB_PUSH_BUTTON" }, { 660, "JOB_USE_TELEPORT" }, { 740, "JOB_MAINTAIN_OBJECT" },
    { 750, "JOB_BUILD_SENTRY" }, { 510, "JOB_BUILD_DISPENSER" }, { 690, "JOB_BUILD_TELEPORT" },
    ...
    { 720, "JOB_INFECTED_ATTACK" }, { 760, "JOB_BIN_GRENADE" },
