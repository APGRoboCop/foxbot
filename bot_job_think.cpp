...
const jobList_struct jl[JOB_TYPE_TOTAL] = {
    { 490, "JOB_SEEK_WAYPOINT" }, { PRIORITY_MAXIMUM, "JOB_GET_UNSTUCK" }, { 0, "JOB_ROAM" }, { 350, "JOB_CHAT" },
    { 500, "JOB_REPORT" }, { 480, "JOB_PICKUP_ITEM" }, { 510, "JOB_PICKUP_FLAG" },
    { PRIORITY_MAXIMUM - 3, "JOB_PUSH_BUTTON" }, { 660, "JOB_USE_TELEPORT" }, { PRIORITY_MAXIMUM - 4, "JOB_MAINTAIN_OBJECT" },
    { 760, "JOB_BUILD_SENTRY" }, { 520, "JOB_BUILD_DISPENSER" }, { 690, "JOB_BUILD_TELEPORT" },
    { 540, "JOB_BUFF_ALLY" }, { 560, "JOB_ESCORT_ALLY" },
    { 450, "JOB_CALL_MEDIC" }, // this should be a higher priority than JOB_GET_HEALTH
    { 440, "JOB_GET_HEALTH" }, { 420, "JOB_GET_ARMOR" }, { 470, "JOB_GET_AMMO" }, { 600, "JOB_DISGUISE" },
    { 190, "JOB_FEIGN_AMBUSH" }, { 580, "JOB_SNIPE" }, { 250, "JOB_GUARD_WAYPOINT" }, { 650, "JOB_DEFEND_FLAG" },
    { 630, "JOB_GET_FLAG" }, { 720, "JOB_CAPTURE_FLAG" }, { 340, "JOB_HARRASS_DEFENSE" },
    { 700, "JOB_ROCKET_JUMP" }, { 740, "JOB_CONCUSSION_JUMP" },
    { 380, "JOB_DETPACK_WAYPOINT" }, { 550, "JOB_PIPETRAP" }, { 570, "JOB_INVESTIGATE_AREA" },
    { 610, "JOB_PURSUE_ENEMY" }, { 200, "JOB_PATROL_HOME" }, { 710, "JOB_SPOT_STIMULUS" },
    { 640, "JOB_ATTACK_BREAKABLE" }, { 430, "JOB_ATTACK_TELEPORT" }, { 620, "JOB_SEEK_BACKUP" },
    { 300, "JOB_AVOID_ENEMY" }, { PRIORITY_MAXIMUM - 1, "JOB_AVOID_AREA_DAMAGE" },
    { 730, "JOB_INFECTED_ATTACK" }, { PRIORITY_MAXIMUM - 2, "JOB_BIN_GRENADE" },
    { PRIORITY_MAXIMUM - 5, "JOB_DROWN_RECOVER" }, { 240, "JOB_MELEE_WARRIOR" }, { 210, "JOB_GRAFFITI_ARTIST" },
};
