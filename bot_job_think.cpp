...
const jobList_struct jl[JOB_TYPE_TOTAL] = {
    ...
    { 400, "JOB_BUFF_ALLY" }, { 580, "JOB_ESCORT_ALLY" },
    { 460, "JOB_CALL_MEDIC" }, // this should be a higher priority than JOB_GET_HEALTH
    { 450, "JOB_GET_HEALTH" }, { 440, "JOB_GET_ARMOR" }, { 540, "JOB_GET_AMMO" }, { 610, "JOB_DISGUISE" },
    { 190, "JOB_FEIGN_AMBUSH" }, { 600, "JOB_SNIPE" }, { 250, "JOB_GUARD_WAYPOINT" }, { 670, "JOB_DEFEND_FLAG" },
