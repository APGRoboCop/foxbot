...
const jobList_struct jl[JOB_TYPE_TOTAL] = {
    ...
    { 800, "JOB_PUSH_BUTTON" }, { 660, "JOB_USE_TELEPORT" }, { 730, "JOB_MAINTAIN_OBJECT" },
    ...
    { 450, "JOB_GET_HEALTH" }, { 440, "JOB_GET_ARMOR" }, { 500, "JOB_GET_AMMO" }, { 600, "JOB_DISGUISE" },
    { 190, "JOB_FEIGN_AMBUSH" }, { 580, "JOB_SNIPE" }, { 250, "JOB_GUARD_WAYPOINT" }, { 650, "JOB_DEFEND_FLAG" },
    { 610, "JOB_GET_FLAG" }, { 740, "JOB_CAPTURE_FLAG" }, { 340, "JOB_HARRASS_DEFENSE" },
    { 680, "JOB_ROCKET_JUMP" }, { 720, "JOB_CONCUSSION_JUMP" },
    { 390, "JOB_DETPACK_WAYPOINT" }, { 550, "JOB_PIPETRAP" }, { 570, "JOB_INVESTIGATE_AREA" },
    { 630, "JOB_PURSUE_ENEMY" }, { 200, "JOB_PATROL_HOME" }, { 700, "JOB_SPOT_STIMULUS" },
    { 640, "JOB_ATTACK_BREAKABLE" }, { 430, "JOB_ATTACK_TELEPORT" }, { 620, "JOB_SEEK_BACKUP" },
    { 300, "JOB_AVOID_ENEMY" }, { 750, "JOB_AVOID_AREA_DAMAGE" },
    { 710, "JOB_INFECTED_ATTACK" }, { 770, "JOB_BIN_GRENADE" },
