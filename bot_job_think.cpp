...
jobList_struct jl[JOB_TYPE_TOTAL] = {
	...
	{ 770, "JOB_BUILD_SENTRY" }, { 510, "JOB_BUILD_DISPENSER" }, { 680, "JOB_BUILD_TELEPORT" },
	{ 450, "JOB_BUFF_ALLY" }, { 550, "JOB_ESCORT_ALLY" },
	{ 470, "JOB_CALL_MEDIC" }, // this should be a higher priority than JOB_GET_HEALTH
	{ 460, "JOB_GET_HEALTH" }, { 440, "JOB_GET_ARMOR" }, { 500, "JOB_GET_AMMO" }, { 670, "JOB_DISGUISE" },
	...
	{ 400, "JOB_DETPACK_WAYPOINT" }, { 540, "JOB_PIPETRAP" }, { 520, "JOB_INVESTIGATE_AREA" },
