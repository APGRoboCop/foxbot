...
const jobList_struct jl[JOB_TYPE_TOTAL] = {
	...
	{ 570, "JOB_REPORT" }, { 480, "JOB_PICKUP_ITEM" }, { 510, "JOB_PICKUP_FLAG" },
	{ 800, "JOB_PUSH_BUTTON" }, { 680, "JOB_USE_TELEPORT" }, { 780, "JOB_MAINTAIN_OBJECT" },
	{ 770, "JOB_BUILD_SENTRY" }, { 550, "JOB_BUILD_DISPENSER" }, { 690, "JOB_BUILD_TELEPORT" },
	{ 430, "JOB_BUFF_ALLY" }, { 560, "JOB_ESCORT_ALLY" },
	{ 460, "JOB_CALL_MEDIC" }, // this should be a higher priority than JOB_GET_HEALTH
	{ 450, "JOB_GET_HEALTH" }, { 440, "JOB_GET_ARMOR" }, { 610, "JOB_GET_AMMO" }, { 600, "JOB_DISGUISE" },
	{ 190, "JOB_FEIGN_AMBUSH" }, { 580, "JOB_SNIPE" }, { 250, "JOB_GUARD_WAYPOINT" }, { 670, "JOB_DEFEND_FLAG" },
	{ 620, "JOB_GET_FLAG" }, { 750, "JOB_CAPTURE_FLAG" }, { 340, "JOB_HARRASS_DEFENSE" },
	{ 650, "JOB_ROCKET_JUMP" }, { 720, "JOB_CONCUSSION_JUMP" },
	{ 390, "JOB_DETPACK_WAYPOINT" }, { 500, "JOB_PIPETRAP" }, { 590, "JOB_INVESTIGATE_AREA" },
	{ 640, "JOB_PURSUE_ENEMY" }, { 200, "JOB_PATROL_HOME" }, { 700, "JOB_SPOT_STIMULUS" },
	{ 660, "JOB_ATTACK_BREAKABLE" }, { 400, "JOB_ATTACK_TELEPORT" }, { 630, "JOB_SEEK_BACKUP" },
