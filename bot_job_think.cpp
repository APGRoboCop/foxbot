...
jobList_struct jl[JOB_TYPE_TOTAL] = {   //Only handles 32 not 45? [APG]RoboCop[CL]
    ...
    { 680, "JOB_REPORT" }, { 480, "JOB_PICKUP_ITEM" }, { 530, "JOB_PICKUP_FLAG" },
    { 800, "JOB_PUSH_BUTTON" }, { 650, "JOB_USE_TELEPORT" }, { 750, "JOB_MAINTAIN_OBJECT" },
    { 760, "JOB_BUILD_SENTRY" }, { 510, "JOB_BUILD_DISPENSER" }, { 700, "JOB_BUILD_TELEPORT" },
    ...
    { 190, "JOB_FEIGN_AMBUSH" }, { 560, "JOB_SNIPE" }, { 250, "JOB_GUARD_WAYPOINT" }, { 630, "JOB_DEFEND_FLAG" },
    { 690, "JOB_GET_FLAG" }, { 780, "JOB_CAPTURE_FLAG" }, { 340, "JOB_HARRASS_DEFENSE" },
    { 610, "JOB_ROCKET_JUMP" }, { 730, "JOB_CONCUSSION_JUMP" },
    { 390, "JOB_DETPACK_WAYPOINT" }, { 540, "JOB_PIPETRAP" }, { 590, "JOB_INVESTIGATE_AREA" },
