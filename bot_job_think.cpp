...
const jobList_struct jl[JOB_TYPE_TOTAL] = {
	...
	{ 800, "JOB_PUSH_BUTTON" }, { 680, "JOB_USE_TELEPORT" }, { 790, "JOB_MAINTAIN_OBJECT" },
	{ 770, "JOB_BUILD_SENTRY" }, { 550, "JOB_BUILD_DISPENSER" }, { 690, "JOB_BUILD_TELEPORT" },
	{ 450, "JOB_BUFF_ALLY" }, { 560, "JOB_ESCORT_ALLY" },
	{ 460, "JOB_CALL_MEDIC" }, // this should be a higher priority than JOB_GET_HEALTH
	{ 440, "JOB_GET_HEALTH" }, { 430, "JOB_GET_ARMOR" }, { 620, "JOB_GET_AMMO" }, { 610, "JOB_DISGUISE" },
	...
	{ 600, "JOB_ROCKET_JUMP" }, { 720, "JOB_CONCUSSION_JUMP" },
	{ 390, "JOB_DETPACK_WAYPOINT" }, { 500, "JOB_PIPETRAP" }, { 590, "JOB_INVESTIGATE_AREA" },
	{ 660, "JOB_PURSUE_ENEMY" }, { 200, "JOB_PATROL_HOME" }, { 700, "JOB_SPOT_STIMULUS" },
	{ 640, "JOB_ATTACK_BREAKABLE" }, { 400, "JOB_ATTACK_TELEPORT" }, { 630, "JOB_SEEK_BACKUP" },
