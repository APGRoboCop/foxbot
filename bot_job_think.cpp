...
const jobList_struct jl[JOB_TYPE_TOTAL] = {
    { 490, "JOB_SEEK_WAYPOINT" }, { PRIORITY_MAXIMUM, "JOB_GET_UNSTUCK" }, { 0, "JOB_ROAM" }, { 360, "JOB_CHAT" },
    { 540, "JOB_REPORT" }, { 480, "JOB_PICKUP_ITEM" }, { 510, "JOB_PICKUP_FLAG" },
    ...
    { 500, "JOB_BUFF_ALLY" }, { 560, "JOB_ESCORT_ALLY" },
    { 450, "JOB_CALL_MEDIC" }, // this should be a higher priority than JOB_GET_HEALTH
    { 440, "JOB_GET_HEALTH" }, { 420, "JOB_GET_ARMOR" }, { 460, "JOB_GET_AMMO" }, { 600, "JOB_DISGUISE" },
    { 190, "JOB_FEIGN_AMBUSH" }, { 580, "JOB_SNIPE" }, { 250, "JOB_GUARD_WAYPOINT" }, { 650, "JOB_DEFEND_FLAG" },
    { 610, "JOB_GET_FLAG" }, { 750, "JOB_CAPTURE_FLAG" }, { 340, "JOB_HARRASS_DEFENSE" },
    ...
    { 720, "JOB_INFECTED_ATTACK" }, { PRIORITY_MAXIMUM - 2, "JOB_BIN_GRENADE" },
