...
const jobList_struct jl[JOB_TYPE_TOTAL] = {
	{ 500, "JOB_SEEK_WAYPOINT" }, { PRIORITY_MAXIMUM, "JOB_GET_UNSTUCK" }, { 0, "JOB_ROAM" }, { 400, "JOB_CHAT" },
	{ 570, "JOB_REPORT" }, { 480, "JOB_PICKUP_ITEM" }, { 510, "JOB_PICKUP_FLAG" },
	{ 800, "JOB_PUSH_BUTTON" }, { 680, "JOB_USE_TELEPORT" }, { 790, "JOB_MAINTAIN_OBJECT" },
	{ 770, "JOB_BUILD_SENTRY" }, { 540, "JOB_BUILD_DISPENSER" }, { 690, "JOB_BUILD_TELEPORT" },
	{ 490, "JOB_BUFF_ALLY" }, { 600, "JOB_ESCORT_ALLY" },
	{ 460, "JOB_CALL_MEDIC" }, // this should be a higher priority than JOB_GET_HEALTH
	{ 450, "JOB_GET_HEALTH" }, { 440, "JOB_GET_ARMOR" }, { 670, "JOB_GET_AMMO" }, { 610, "JOB_DISGUISE" },
	{ 190, "JOB_FEIGN_AMBUSH" }, { 560, "JOB_SNIPE" }, { 250, "JOB_GUARD_WAYPOINT" }, { 660, "JOB_DEFEND_FLAG" },
	{ 650, "JOB_GET_FLAG" }, { 750, "JOB_CAPTURE_FLAG" }, { 340, "JOB_HARRASS_DEFENSE" },
	{ 580, "JOB_ROCKET_JUMP" }, { 720, "JOB_CONCUSSION_JUMP" },
	{ 390, "JOB_DETPACK_WAYPOINT" }, { 470, "JOB_PIPETRAP" }, { 590, "JOB_INVESTIGATE_AREA" },
	{ 640, "JOB_PURSUE_ENEMY" }, { 210, "JOB_PATROL_HOME" }, { 700, "JOB_SPOT_STIMULUS" },
	{ 620, "JOB_ATTACK_BREAKABLE" }, { 420, "JOB_ATTACK_TELEPORT" }, { 630, "JOB_SEEK_BACKUP" },
