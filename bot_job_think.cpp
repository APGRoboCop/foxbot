...
const jobList_struct jl[JOB_TYPE_TOTAL] = {
	...
	{ 400, "JOB_BUFF_ALLY" }, { 560, "JOB_ESCORT_ALLY" },
	{ 460, "JOB_CALL_MEDIC" }, // this should be a higher priority than JOB_GET_HEALTH
	{ 450, "JOB_GET_HEALTH" }, { 440, "JOB_GET_ARMOR" }, { 600, "JOB_GET_AMMO" }, { 610, "JOB_DISGUISE" },
	...
	{ 640, "JOB_ROCKET_JUMP" }, { 720, "JOB_CONCUSSION_JUMP" },
	{ 390, "JOB_DETPACK_WAYPOINT" }, { 500, "JOB_PIPETRAP" }, { 590, "JOB_INVESTIGATE_AREA" },
	{ 650, "JOB_PURSUE_ENEMY" }, { 200, "JOB_PATROL_HOME" }, { 700, "JOB_SPOT_STIMULUS" },
	{ 660, "JOB_ATTACK_BREAKABLE" }, { 430, "JOB_ATTACK_TELEPORT" }, { 630, "JOB_SEEK_BACKUP" },
