...
// these must be in the right order for each job to run properly
const jobList_struct jl[JOB_TYPE_TOTAL] = {   //Only handles 32 not 45? [APG]RoboCop[CL]
	{ PRIORITY_MAXIMUM, "JOB_GET_UNSTUCK" },
    { 800, "JOB_PUSH_BUTTON" },
    { 790, "JOB_DROWN_RECOVER" },
    { 760, "JOB_BUILD_SENTRY" },
    { 720, "JOB_INFECTED_ATTACK" },
    { 700, "JOB_ROCKET_JUMP" },
    { 640, "JOB_ATTACK_BREAKABLE" },
    { 630, "JOB_PURSUE_ENEMY" },
    { 610, "JOB_GET_FLAG" },
    { 540, "JOB_REPORT" },
	...
	{ 780, "JOB_BIN_GRENADE" },
	{ 770, "JOB_AVOID_AREA_DAMAGE" },
	{ 750, "JOB_CAPTURE_FLAG" },
	{ 740, "JOB_MAINTAIN_OBJECT" },
	{ 730, "JOB_CONCUSSION_JUMP" },
	{ 710, "JOB_SPOT_STIMULUS" },
	{ 690, "JOB_BUILD_TELEPORT" },
	{ 660, "JOB_USE_TELEPORT" },
	{ 650, "JOB_DEFEND_FLAG" },
	{ 620, "JOB_SEEK_BACKUP" },
	{ 600, "JOB_DISGUISE" },
	{ 580, "JOB_SNIPE" },
	{ 570, "JOB_INVESTIGATE_AREA" },
	{ 560, "JOB_ESCORT_ALLY" },
	{ 550, "JOB_PIPETRAP" },
