...
const jobList_struct jl[JOB_TYPE_TOTAL] = {
    { 390, "JOB_SEEK_WAYPOINT" }, { PRIORITY_MAXIMUM, "JOB_GET_UNSTUCK" }, { 0, "JOB_ROAM" }, { 450, "JOB_CHAT" },
    { 500, "JOB_REPORT" }, { 480, "JOB_PICKUP_ITEM" }, { 410, "JOB_PICKUP_FLAG" },
    { PRIORITY_MAXIMUM - 4, "JOB_PUSH_BUTTON" }, { 610, "JOB_USE_TELEPORT" }, { PRIORITY_MAXIMUM - 3, "JOB_MAINTAIN_OBJECT" },
    { PRIORITY_MAXIMUM, "JOB_BUILD_SENTRY" }, { 510, "JOB_BUILD_DISPENSER" }, { 700, "JOB_BUILD_TELEPORT" },
    { 570, "JOB_BUFF_ALLY" }, { 560, "JOB_ESCORT_ALLY" },
    { 550, "JOB_CALL_MEDIC" }, // this should be a higher priority than JOB_GET_HEALTH
    { 440, "JOB_GET_HEALTH" }, { 420, "JOB_GET_ARMOR" }, { 490, "JOB_GET_AMMO" }, { 600, "JOB_DISGUISE" },
    { 190, "JOB_FEIGN_AMBUSH" }, { 580, "JOB_SNIPE" }, { 250, "JOB_GUARD_WAYPOINT" }, { 640, "JOB_DEFEND_FLAG" },
    { 530, "JOB_GET_FLAG" }, { 720, "JOB_CAPTURE_FLAG" }, { 340, "JOB_HARRASS_DEFENSE" },
    { PRIORITY_MAXIMUM - 1, "JOB_ROCKET_JUMP" }, { PRIORITY_MAXIMUM, "JOB_CONCUSSION_JUMP" },
    { 380, "JOB_DETPACK_WAYPOINT" }, { 450, "JOB_PIPETRAP" }, { 520, "JOB_INVESTIGATE_AREA" },
    { 620, "JOB_PURSUE_ENEMY" }, { 200, "JOB_PATROL_HOME" }, { 710, "JOB_SPOT_STIMULUS" },
    { 630, "JOB_ATTACK_BREAKABLE" }, { 430, "JOB_ATTACK_TELEPORT" }, { 650, "JOB_SEEK_BACKUP" },
    { 400, "JOB_AVOID_ENEMY" }, { PRIORITY_MAXIMUM - 1, "JOB_AVOID_AREA_DAMAGE" },
